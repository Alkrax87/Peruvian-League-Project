...
function cargarDatos() {
   return fetch('./js/eliminatorias.json')
...
cargarDatos().then(datos => {
   ...
   document.getElementById("nombreH").innerHTML = "<b>"+datos.Info.nombre+"</b>";
   document.getElementById("nombreR").innerHTML = "<b>"+datos.Info.nombre+"</b>";
